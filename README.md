...
This repo contains an arduino application that runs on Raspberry Pi 3 with a PIR sensor, and then sends these data to your IoT hub. At the same time, this application receives Cloud-to-Device message from your IoT hub, and takes actions according to the C2D command. 
...
### Connect with a physical PIR sensor and LED
You can follow the instruction here to connect your PIR and a LED with your Raspberry Pi 3.
